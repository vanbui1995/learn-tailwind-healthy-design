    ...
    <div className={'flex max-w-[960px] items-center flex-col justify-center my-0 mx-auto'}>
      <div className='flex gap-[8px] flex-wrap max-lg:p-[8px]'>
        {recommendedItems.map(item => (
          <div style={{ backgroundImage: `url(${item.image})` }} key={item.id} className={'flex-1 min-w-[234px] w-[25%] max-md:w-1/3 h-[234px] relative bg-cover bg-center bg-secondary300'}>
            <span className={'bg-primary300 text-white text-[15px] absolute bottom-[0px] w-[120px] p-[7px]'}>{item.meal}</span>
          </div>
